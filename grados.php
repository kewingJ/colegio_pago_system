                        ...
                        <div class="modal-body">
                            <form id="Form1" class="FormNuevo" action="" method="" autocomplete="off">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="number" class="form-control" name="cupo" placeholder="">
                                </div>
            ...
            <div class="modal fade" id="ModalEditar" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div id="content_dynamic_edit_grado">
        ...
        <script>
            $(function () {
                $('#example1').DataTable({
                    "processing": true,
                    "serverSide": true,
                    "ajax": "ajax_table/ajax_table_grados.php",
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                $(document).on('click', '#btnGardar', function(e){
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'controller/g_grado.php',
                        data: $('.FormNuevo').serialize(),
                        success: function(data) {
                            if (data == 'bien') {
                                not1();
                                setTimeout("location.href = 'grados.php'",3000);
                            } else{
                                not2();
                            }
                        }
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                $(document).on('click', '.btn1', function(e){
                    e.preventDefault();
                    var id_grado = $(this).data('id');
                    // alert(id_usuario);
                    $('#content_dynamic_edit_grado').html('');  
                    $.ajax({
                        url: 'controller/get_grado_edit.php',
                        type: 'POST',
                    ...
                    .done(function(data){  
                        $('#content_dynamic_edit_grado').html('');    
                        $('#content_dynamic_edit_grado').html(data); // mostrar la data
                    })
                    .fail(function(){
                        $('#content_dynamic_edit_grado').html('<i class="glyphicon glyphicon-info-sign"></i> Something went wrong, Please try again...');
                    });
                });
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                $(document).on('click', '#btnEliminar', function(e){
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'controller/e_grado.php',
                        data: 'id_grado='+id_grado,
                        success: function(data) {
                            if (data == 'bien') {
                                not4();
                                setTimeout("location.href = 'grados.php'",2000);
                            } else {
                                not5();
                            }
                        }
