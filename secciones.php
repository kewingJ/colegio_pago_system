                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Nueva grado</h5>
                        </div>
                        <div class="modal-body">
                            <form id="Form1" class="FormNuevo" action="" method="" autocomplete="off">
                                ...
                                <div class="form-group col-md-12">
                                    <label>Seccion</label>
                                    <input type="text" class="form-control" name="seccion" placeholder="">
                                </div>
            ...
            <div class="modal fade" id="ModalEditar" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div id="content_dynamic_edit_seccion">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="Form2" class="FormC" action="" method="" autocomplete="off">
                                <h4 class="text-center">¿Esta seguro de eliminar este grado?</h4>
        ...
        <script>
            $(function () {
                $('#example1').DataTable({
                    "processing": true,
                    "serverSide": true,
                    "ajax": "ajax_table/ajax_table_secciones.php",
                            ...
                            $('td', row).eq(2).html(`
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a class="dropdown-item btn1" href="#" data-id="${data[2]}" data-bs-toggle="modal" data-bs-target="#ModalEditar">
                                                <i class="fa fa-edit"></i> Editar
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item btn2" href="#" data-id="${data[2]}" data-bs-toggle="modal" data-bs-target="#modalEliminar">
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                $(document).on('click', '#btnGardar', function(e){
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'controller/g_seccion.php',
                        data: $('.FormNuevo').serialize(),
                        success: function(data) {
                            if (data == 'bien') {
                                not1();
                                setTimeout("location.href = 'secciones.php'",3000);
                            } else{
                                not2();
                            }
                        }
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                $(document).on('click', '.btn1', function(e){
                    e.preventDefault();
                    var id_seccion = $(this).data('id');
                    // alert(id_usuario);
                    $('#content_dynamic_edit_seccion').html('');  
                    $.ajax({
                        url: 'controller/get_seccion_edit.php',
                        type: 'POST',
                    ...
                    .done(function(data){  
                        $('#content_dynamic_edit_seccion').html('');    
                        $('#content_dynamic_edit_seccion').html(data); // mostrar la data
                    })
                    .fail(function(){
                        $('#content_dynamic_edit_seccion').html('<i class="glyphicon glyphicon-info-sign"></i> Something went wrong, Please try again...');
                    });
                });
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                $(document).on('click', '#btnEliminar', function(e){
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'controller/e_seccion.php',
                        data: 'id_seccion='+id_seccion,
                        success: function(data) {
                            if (data == 'bien') {
                                not4();
                                setTimeout("location.href = 'secciones.php'",2000);
                            } else {
                                not5();
                            }
                        }
