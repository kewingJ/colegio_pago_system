                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="Form2" class="FormC" action="" method="" autocomplete="off">
                                <h4 class="text-center">¿Esta seguro de eliminar la categoria?</h4>
        ...
        <script>
            $(function () {
                $('#example1').DataTable({
                    "processing": true,
                    "serverSide": true,
                    "ajax": "ajax_table/ajax_table_categoria.php",
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                $(document).on('click', '#btnGardar', function(e){
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'controller/g_categoria.php',
                        data: $('.FormNuevo').serialize(),
                        success: function(data) {
                            if (data == 'bien') {
                                not1();
                                setTimeout("location.href = 'categoria_pago.php'",3000);
                            } 
                            else if (data == 'Categoria ya existe') {
                                not6();
                            }
                            else {
                                not2();
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                $(document).on('click', '.btn1', function(e){
                    ...
                    $.ajax({
                        url: 'controller/get_categoria_edit.php',
                        type: 'POST',
                ...
                $(document).on('click', '#btnA', function(e){
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'controller/a_categoria.php',
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                $(document).on('click', '#btnEliminar', function(e){
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'controller/e_categoria.php',
                        data: 'id_categoria='+id_categoria,
                        success: function(data) {
                            if (data == 'bien') {
                                not4();
                                setTimeout("location.href = 'categoria_pago.php'",2000);
                            } else {
                                not5();
                            }
                        }
