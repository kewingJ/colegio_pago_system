                                    ...
                                    <form id="Form1" class="FormFiltro" action="" method="" autocomplete="off">
                                        <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <select data-plugin-selectTwo2 id="dropdown1" class="form-control" style="width: 100%">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <select data-plugin-selectTwo2 id="dropdown2" class="form-control" style="width: 100%">
									...
									<table class="table table-sm table-bordered table-striped small mb-0" id="example1">
										...
										<tfoot>
                                            <tr>
                                                ...
                                                <th id="footer-total" class="text-end"></th>
                                            </tr>
                                        </tfoot>
									</table>
								</div>
        ...
        <script>
            $(function () {
                $('#example1').DataTable({
                    ...
                    "serverSide": true,
                    "order": [[2, 'desc']],
                    "ajax": "ajax_table/ajax_table_reporte_transporte.php",
                ...
                $('#dropdown2').on('change',function(){
                    ...
                    table.columns(6).search(this.value.toUpperCase()).draw();
					actualizarTotalFiltrado();
                });
            });
            ...
            function actualizarTotalFiltrado() {
                const anio      	= $('#dropdown1').val() || ''; // año lectivo
                const id_alumno     = $('#dropdown2').val() || ''; // alumno (id_alumno)

                $.getJSON('controller/sum_reporte_transporte.php', {
                    anio, id_alumno
                }).done(function (resp) {
                    // Pinta en el pie (columna 5)
                    const api = $('#example1').DataTable().api ? $('#example1').DataTable().api() : $('#example1').DataTable();
                    $(api.column(5).footer()).html('C$ ' + resp.totalFiltrado);
                }).fail(function () {
                    // opcional: deja vacío o muestra 0
                    const api = $('#example1').DataTable();
                    $(api.column(5).footer()).html('C$ 0.00');
                });
            }
        </script>
        ...
        <script>
            $(document).ready(function() {
                $('#dropdown1').change(function(e) {
                    ...
                    .done(function(data){  
                        $('#dropdown2').html('');    
                        $('#dropdown2').html(data); // mostrar la data
                    })
                    .fail(function(){
                        $('#dropdown2').html('<i class="glyphicon glyphicon-info-sign"></i> Something went wrong, Please try again...');
                    });
                });
            });
        </script>
