							...
							<section class="card">
								...
								<div class="card-body">
                                    ...
                                    <table class="table table-sm table-bordered table-striped small mb-0" id="example1">
										...
										<tbody>
                                            <?php
                                                $queryUser = mysqli_query($link,"SELECT * FROM tbla_usuario WHERE activo_usuario = 1 ORDER BY id_usuario DESC");
                                                $cont = 1;
                                                while($rowUser = mysqli_fetch_array($queryUser))
                                                {
                                                    $tipo_usuario = $rowUser['tipo_usuario'] == 1 ? 'Administrador' : 'Gerencia';
                                                    echo '
                                                            <tr>
                                                                <td>'.$cont.'</td>
                                                                <td>'.$rowUser['nombre_usuario'].' '.$rowUser['apellido_usuario'].'</td>
                                                                <td>'.$rowUser['email_usuario'].'</td>
                                                                <td>'.$tipo_usuario.'</td>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="Form1" class="FormUsuario" action="" method="" autocomplete="off">
                                <div class="row">
                                    <div class="col-md-6">
                                        <label>Nombres</label>
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                $(document).on('click', '.btn2', function(e){
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'controller/e_usuario.php',
                        data: parametro,
                        success: function(data) {
                            if (data == 'bien') {
                                not4();
                                setTimeout("location.href = 'usuarios.php'",2000);
                            } else {
                                not5();
                            }
                        }
