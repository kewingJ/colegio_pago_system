							...
							<section class="card">
								<header class="card-header">
                                    ...
                                    <button class="btn btn-success"
                                        ...
                                        <i class="fa fa-plus"></i> Nuevo año lectivo
                                    </button>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Nueva año lectivo</h5>
                        </div>
            ...
            <div class="modal fade" id="ModalEditar" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div id="content_dynamic_edit_categoria">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="Form2" class="FormC" action="" method="" autocomplete="off">
                                <h4 class="text-center">¿Esta seguro de eliminar el año lectivo?</h4>
        ...
        <script>
            $(function () {
                $('#example1').DataTable({
                    "processing": true,
                    "serverSide": true,
                    "ajax": "ajax_table/ajax_table_year_lectivo.php",
                    "createdRow": function ( row, data, index ) {

                        // 
                        if (data[2] == 0) {
                            $('td', row).eq(2).addClass("text-center");
                            $('td', row).eq(2).html('<span class="label label-danger">Inactivo</span>');
                        } else {
                            $('td', row).eq(2).addClass("text-center");
                            $('td', row).eq(2).html('<span class="label label-success">Activo</span>');
                        }
                        //
                        if (data[3]) {
                            ...
                            $('td', row).eq(3).html(`
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a class="dropdown-item btn1" href="#" data-id="${data[3]}" data-bs-toggle="modal" data-bs-target="#ModalEditar">
                                                <i class="fa fa-edit"></i> Editar
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item btn2" href="#" data-id="${data[3]}" data-bs-toggle="modal" data-bs-target="#modalEliminar">
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                $(document).on('click', '#btnGardar', function(e){
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'controller/g_year_lectivo.php',
                        data: $('.FormNuevo').serialize(),
                        success: function(data) {
                            if (data == 'bien') {
                                not1();
                                setTimeout("location.href = 'year_lectivo.php'",3000);
                            } else {
                                alert(data);
                            }
                        }
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                $(document).on('click', '.btn1', function(e){
                    e.preventDefault();
                    var id_anio = $(this).data('id');
                    // alert(id_usuario);
                    $('#content_dynamic_edit_categoria').html('');  
                    $.ajax({
                        url: 'controller/get_year_lectivo_edit.php',
                        type: 'POST',
                    ...
                    .done(function(data){  
                        $('#content_dynamic_edit_categoria').html('');    
                        $('#content_dynamic_edit_categoria').html(data); // mostrar la data
                    })
                    .fail(function(){
                        $('#content_dynamic_edit_categoria').html('<i class="glyphicon glyphicon-info-sign"></i> Something went wrong, Please try again...');
                    });
                });
                ...
                $(document).on('click', '#btnA', function(e){
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'controller/a_year_lectivo.php',
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                $(document).on('click', '#btnEliminar', function(e){
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'controller/e_year_lectivo.php',
                        data: 'id_anio='+id_anio,
                        success: function(data) {
                            if (data == 'bien') {
                                not4();
                                setTimeout("location.href = 'year_lectivo.php'",2000);
                            } else {
                                not5();
                            }
                        }
