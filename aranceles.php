		...
		<section class="body">
							...
							<section class="card">
								<header class="card-header">
                                    ...
                                    <button class="btn btn-success"
                                        ...
                                        <i class="fa fa-plus"></i> Nuevo arancel
                                    </button>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Nuevo arancel</h5>
                        </div>
            ...
            <div class="modal fade" id="ModalEditar">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Editar arancel</h5>
                        </div>
                        <div class="modal-body">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="Form2" class="FormC" action="" method="" autocomplete="off">
                                <h4 class="text-center">¿Esta seguro de eliminar el arancel?</h4>
                                <input type="hidden" name="id_arancel" id="id_arancel">
        ...
        <script>
            $(function () {
                ...
                var table = $('#example1').DataTable({
                    "columnDefs": [{ visible: false, targets: [groupColumn, 0] }],
                    "order": [[groupColumn, 'desc']],
                    "processing": true,
                    "serverSide": true,
                    "ajax": "ajax_table/ajax_table_aranceles.php",
                    "scrollX": true,
                            ...
                            $('td', row).eq(5).html(`
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        {
                                        ?>
                                        <li><a class="dropdown-item btn1" href="#" data-id="${data[7]}" data-bs-toggle="modal" data-bs-target="#ModalEditar"><i class="fa fa-edit"></i> Editar</a></li>
                                        <?php
                                        }
                                        if ($_SESSION['tipo_usuario'] == 2) 
                                        {
                                        ?>
                                        <li><a class="dropdown-item btn2" href="#" data-id="${data[7]}" data-bs-toggle="modal" data-bs-target="#modalEliminar"><i class="fa fa-trash"></i> Eliminar</a></li>
                                        <?php
                                        }
                                        ?>
                                    </ul>
                        ...
                        .each(function (group, i) {
                            if (last !== group) {
                                $(rows)
                                    .eq(i)
                                    .before(
                                        '<tr class="group"><td style="color: #FFFFFF; background: #3c8dbc;" colspan="6">' +
                                            group +
                                        '</td></tr>'
                                    );
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                $(document).on('click', '#btnGardar', function(e){
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'controller/g_arancel.php',
                        data: $('.FormNuevo').serialize(),
                        success: function(data) {
                            if (data == 'bien') {
                                not1();
                                setTimeout("location.href = 'aranceles.php'",3000);
                            } else{
                                not2();
                            }
                        }
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                $(document).on('click', '.btn1', function(e){
                    e.preventDefault();
                    var id_arancel = $(this).data('id');
                    // alert(id_usuario);
                    $('#content_dynamic_edit_arancel').html('');  
                    $.ajax({
                        url: 'controller/get_arancel_edit.php',
                        type: 'POST',
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                $(document).on('click', '#btnEliminar', function(e){
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'controller/e_arancel.php',
                        data: 'id_arancel='+id_arancel,
                        success: function(data) {
                            if (data == 'bien') {
                                not4();
                                setTimeout("location.href = 'aranceles.php'",2000);
                            } else {
                                not5();
                            }
                        }
