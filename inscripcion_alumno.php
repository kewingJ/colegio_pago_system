...
<html class="fixed">
	...
	<body>
							...
							<section class="card">
								<header class="card-header">
                                    ...
                                    <button class="btn btn-success"
                                        ...
                                        <i class="fa fa-plus"></i> Nueva inscripcion
                                    </button>
                                    ...
                                    <form id="Form1" class="FormFiltro" action="" method="" autocomplete="off">
                                        <div class="row">
                                                <div class="col-md-3">
                                                    ...
                                                    <select id="dropdown1" data-plugin-selectTwo22 style="width: 100%" name="dropdown1">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <select id="dropdown2" data-plugin-selectTwo22 style="width: 100%" name="dropdown2">
                                                        <option value="">Nivel escolar</option>
                                                        <?php
                                                            $queryData = mysqli_query($link,"SELECT * FROM tbl_nivel");
                                                            while($rowData = mysqli_fetch_array($queryData)){
                                                                echo '<option value="'.$rowData['Nivel'].'">'.$rowData['Nivel'].'</option>';
                                                            }
                                                        ?>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    <label>Grado</label>
                                                    <select id="dropdown3" data-plugin-selectTwo22 style="width: 100%" name="dropdown3">
                                                        <option value="">Grado</option>
                                                        <?php
                                                            $queryData = mysqli_query($link,"SELECT * FROM tbl_grados");
                                                            while($rowData = mysqli_fetch_array($queryData)){
                                                                echo '<option value="'.$rowData['Grado'].'">'.$rowData['Grado'].'</option>';
                                                            }
                                                        ?>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    <label>Seccion</label>
                                                    <select id="dropdown4" data-plugin-selectTwo22 style="width: 100%" name="dropdown4">
                        ...
                        <div class="modal-body">
                            <form id="Form1" class="FormNuevo" action="" method="" autocomplete="off">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <label>Correo</label>
                                        <input type="email" class="form-control" name="email" id="email_new" placeholder="Email">
                                    </div>
        ...
        <script>
            $(document).ready(function() {
                // Inicializa todos los select con data-plugin-selectTwo22
                $('[data-plugin-selectTwo22]').select2({
                    theme: 'bootstrap'
                });
            });
        </script>
        ...
        <script>
            $(function () {
                $('#example1').DataTable({
                    "processing": true,
                    "serverSide": true,
                    "ajax": "ajax_table/ajax_table_alumno_inscrito.php",
                    "createdRow": function ( row, data, index ) {
                        //
                        if (data[8]) {
                            $('td', row).eq(8).addClass("text-center");
                            //$('td', row).eq(6).html('<div class="btn-group"><button type="button" class="btn btn-primary">Opciones</button><button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown"><span class="caret"></span><span class="sr-only">Toggle Dropdown</span></button><ul class="dropdown-menu" role="menu"><li><a href="#0" data-toggle="modal" data-target="#ModalEditar" data-id="'+data[6]+'" class="btn1"><i class="fa fa-edit"></i> Editar</a></li><li><a href="#0"data-id="'+data[6]+'" class="btn2"><i class="fa fa-trash"></i> Eliminar</a></li></ul></div>');
                            $('td', row).eq(8).html(`
                                <div class="dropdown">
                                    <button class="btn btn-primary dropdown-toggle" style="font-size: small;" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                        Opciones
                                    </button>
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a class="dropdown-item btn1" href="#" data-id="${data[8]}" data-bs-toggle="modal" data-bs-target="#ModalEditar">
                                                <i class="fa fa-edit"></i> Editar
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item btn2" href="#" data-id="${data[8]}" data-bs-toggle="modal" data-bs-target="#modalEliminar">
        ...
        <!-- consulta al seleccionar alumno -->
         <script>
            $(document).ready(function() {
                $('#id_alumno').change(function(e) {
                    ...
                    $('#email_new').val('');
                    $.ajax({
                        url: 'controller/get_email_alumno.php',
                        type: 'POST',
                    ...
                    .done(function(data){  
                        $('#email_new').val('');
                        $('#email_new').val(data); // mostrar la data
                    })
                    .fail(function(){
                        $('#id_alumno').html('<i class="glyphicon glyphicon-info-sign"></i> Something went wrong, Please try again...');
                    });
