							...
							<section class="card">
								<header class="card-header">
                                    ...
                                    <button class="btn btn-success"
                                        ...
                                        <i class="fa fa-plus"></i> Nuevo concepto de pago
                                    </button>
                        ...
                        <div class="modal-body">
                            <form id="Form1" class="FormNuevo" action="" method="" autocomplete="off">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control" name="concepto" placeholder="">
                                </div>

                                <div class="form-group col-md-12">
                                    <label>Total unidades</label>
                                    <input type="number" class="form-control" value="0" name="unidades" placeholder="">
                                </div>

                                <div class="form-group col-md-12">
                                    <label>Seleccione los niveles donde aplicara el concepto</label>
                                    <?php
                                        $queryData = mysqli_query($link,"SELECT * FROM tbl_nivel");
                                        while($rowData = mysqli_fetch_array($queryData)){
                                            echo '
                                            <div class="checkbox-custom checkbox-default">
                                                <input type="checkbox" name="nivelesCP[]" id="'.$rowData['IdNivel'].'" value="'.$rowData['Nivel'].'">
                                                <label for="'.$rowData['IdNivel'].'">'.$rowData['Nivel'].'</label>
                                            </div>
                                            ';
                                        }
                                    ?>
            ...
            <div class="modal fade" id="ModalEditar" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div id="content_dynamic_edit_concepto">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="Form2" class="FormC" action="" method="" autocomplete="off">
                                <h4 class="text-center">¿Esta seguro de eliminar el concepto?</h4>
        ...
        <script>
            $(function () {
                $('#example1').DataTable({
                    "processing": true,
                    "serverSide": true,
                    "ajax": "ajax_table/ajax_table_copcento.php",
                    "createdRow": function ( row, data, index ) {
                        //
                        if (data[4]) {
                            $('td', row).eq(4).addClass("text-center");
                            //$('td', row).eq(3).html('<div class="btn-group"><button type="button" class="btn btn-primary">Opciones</button><button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown"><span class="caret"></span><span class="sr-only">Toggle Dropdown</span></button><ul class="dropdown-menu" role="menu"><li><a href="#0" data-toggle="modal" data-target="#ModalEditar" data-id="'+data[3]+'" class="btn1"><i class="fa fa-edit"></i> Editar</a></li><li><a href="#0"data-id="'+data[3]+'" class="btn2"><i class="fa fa-trash"></i> Eliminar</a></li></ul></div>');
                            $('td', row).eq(4).html(`
                                <div class="dropdown">
                                    <button style="font-size: small;" class="btn btn-primary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                        Opciones
                                    </button>
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a class="dropdown-item btn1" href="#" data-id="${data[4]}" data-bs-toggle="modal" data-bs-target="#ModalEditar">
                                        ...
                                        ?>
                                        <li>
                                            <a class="dropdown-item btn2" href="#" data-id="${data[4]}" data-bs-toggle="modal" data-bs-target="#modalEliminar">
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                $(document).on('click', '#btnGardar', function(e){
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'controller/g_concepto.php',
                        data: $('.FormNuevo').serialize(),
                        success: function(data) {
                            if (data == 'bien') {
                                not1();
                                setTimeout("location.href = 'concepto_pago.php'",3000);
                            } 
                            else if(data == 'Concepto ya existe'){
                                not6();
                            }
                            else {
                                not2();
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                $(document).on('click', '.btn1', function(e){
                    ...
                    // alert(id_usuario);
                    $('#content_dynamic_edit_concepto').html('');  
                    $.ajax({
                        url: 'controller/get_copcento_edit.php',
                        type: 'POST',
                    ...
                    .done(function(data){  
                        $('#content_dynamic_edit_concepto').html('');    
                        $('#content_dynamic_edit_concepto').html(data); // mostrar la data
                    })
                    .fail(function(){
                        $('#content_dynamic_edit_concepto').html('<i class="glyphicon glyphicon-info-sign"></i> Something went wrong, Please try again...');
                    });
                });
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                $(document).on('click', '#btnEliminar', function(e){
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'controller/e_concepto.php',
                        data: 'id_concepto='+id_concepto,
                        success: function(data) {
                            if (data == 'bien') {
                                not4();
                                setTimeout("location.href = 'concepto_pago.php'",2000);
                            } else {
                                not5();
                            }
                        }
