...
<html class="fixed">
	<head>
		...
		<title>Configuracion Email</title>
							...
							<section class="card">
								...
								<div class="card-body">
                                    ...
                                    <table class="table table-sm table-bordered table-striped small mb-0" id="example1">
										...
										<tbody>
                                            <?php
                                                $queryUser = mysqli_query($link,"SELECT * FROM tbla_email");
                                                $cont = 1;
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                $(document).on('click', '.btn1', function(e){
                    e.preventDefault();
                    var id_email = $(this).data('id');
                    // alert(id_email);
                    $('#content_dynamic_edit_user').html('');  
                    $.ajax({
                        url: 'controller/get_email_edit.php',
                        type: 'POST',
